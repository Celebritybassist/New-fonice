                        ...
                        <div class="col-lg-4 pb-4 pb-lg-0 col-xxl-3  pe-xxl-5">
                            <div class="bg-body border border-bottom-0 shadow-lg">
                                ...
                                <ul class="list-unstyled mb-0 theme-link">
                                    ...
                                    <li class="border-bottom mb-0">
                                        <a class="nav-link-style d-flex align-items-center active p-3" href="account-payment.html">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="card-footer d-flex p-3">
                                            <a class="link-mode text-uppercase fw-500" href="#">Edit </a>
                                            <a class="link-danger text-uppercase fw-500 ms-auto" href="#">Remove</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
