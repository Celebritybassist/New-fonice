        ...
        <main>
            ...
            <div class="py-6">
                <div class="container">
                        ...
                        <table class="table table-bordered align-middle">
                            <thead>
                                <tr class="text-uppercase">
                                    <th class="text-mode text-center fw-500 text-nowrap">Image</th>
                                    <th class="text-mode text-center fw-500 text-nowrap">Product Name</th>
                                    <th class="text-mode text-center fw-500 text-nowrap">Until Price</th>
                                    <th class="text-mode text-center fw-500 text-nowrap">Qty</th>
                                    <th class="text-mode text-center fw-500 text-nowrap">Subtotal</th>
                                    <th class="text-mode fw-500 text-end text-nowrap">action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                    ...
                    <div class="d-flex">
                        <div>
                            <a class="btn btn-outline-mode" href="#">
