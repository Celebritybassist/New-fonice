                ...
                <div class="container py-6 position-relative">
                    <div class="row align-items-center">
                        <div class="col-lg-6 my-2">
                            <h1 class="m-0 h4 text-center text-lg-start text-white">Login</h1>
                        </div>
                        <div class="col-lg-6 my-2">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-xxl-4">
                            ...
                            <div class="text-center pt-4 pb-5">
                                <span class="px-3 bg-body d-inline-block align-top lh-sm">OR</span>
                                <div class="border-bottom mt-n3"></div>
                            </div>
                            <div class="row g-2">
                                <div class="col">
                                    <button class="btn w-100 btn-mode" type="button"><i class="bi bi-facebook me-2"></i> Facebook</button>
                                </div>
                                <div class="col">
                                    <button class="btn w-100 btn-mode" type="button"><i class="bi bi-twitter me-2"></i> Twitter</button>
                                </div>
                            </div>
