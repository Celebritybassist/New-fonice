                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-8">
                            <div class="d-flex justify-content-between align-items-center pb-4 border-bottom mb-4">
                                <h2 class="h5 mb-0">Products</h2><a class="btn btn-outline-primary btn-sm ps-2" href="shop-grid-ls.html"><i class="ci-arrow-left me-2"></i>Continue Shopping</a>
                            </div>
                            <!-- Item-->
                            <div class="d-flex align-items-center flex-row w-100 pb-3 mb-3 border-bottom">
                                <a class="d-inline-block flex-shrink-0 me-3" href="#">
                                    <img src="../../assets/img/fashion2/product-1.jpg" width="120" alt="Product">
                                </a>
                                <div class="d-flex flex-column flex-sm-row col">
                                    <div class="pe-sm-2">
                                        <h3 class="product-title fs-5 mb-1"><a class="text-reset" href="#">Fine-knit sweater</a></h3>
                                        ...
                                        <div class="lead pt-1">$154.00</div>
                                    </div>
                                    <div class="pt-2 pt-sm-0 d-flex d-sm-block ms-sm-auto">
                                        ...
                                        <button class="btn btn-link px-0 text-danger ms-auto" type="button"><i class="bi-trash3 me-2"></i><span class="">Remove</span></button>
                                    </div>
                                </div>
                            </div>
                            <!-- Item-->
                            ...
                            <button class="btn btn-primary d-block w-100 mt-4" type="button"><i class="bi-arrow-repeat fs-base me-2"></i>Update cart</button>
                        </div>
                        ...
                        <div class="col-lg-4 ps-xl-7">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-2 pb-4">
                                        <div class="d-flex">
                                            <input type="text" name="promo" placeholder="Apply promo code" class="form-control form-control-sm"> <button class="btn btn-dark btn-sm ms-2">Apply</button>
                                        </div>
                                    </div>
                                    <div class="d-grid gap-2 mx-auto">
                                        <a class="btn btn-primary" href="checkout-shipping.html"> <i class="bi-credit-card-2-back me-2"></i> Proceed to Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
