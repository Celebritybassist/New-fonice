                ...
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <div class="col-lg-6 lightbox-gallery">
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-1.jpg">
                                    <img src="../../assets/img/fashion/product-1.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-2.jpg">
                                    <img src="../../assets/img/fashion/product-2.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-3.jpg">
                                    <img src="../../assets/img/fashion/product-3.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-4.jpg">
                                    <img src="../../assets/img/fashion/product-4.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-5.jpg">
                                    <img src="../../assets/img/fashion/product-5.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-6.jpg">
                                    <img src="../../assets/img/fashion/product-6.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-7.jpg">
                                    <img src="../../assets/img/fashion/product-7.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                            <div class="mb-3">
                                <a class="gallery-link" href="../../assets/img/fashion/product-8.jpg">
                                    <img src="../../assets/img/fashion/product-8.jpg" class="img-fluid" title="" alt="">
                                </a>
                            </div>
                        </div>
                        <!-- End Product Gallery -->
                            ...
                            <div class="product-detail">
                                ...
                                <div class="product-detail-collapse">
                                    <div class="pd-collapse-row">
                                        <a class="pd-collapse-h5" data-bs-toggle="collapse" href="#pd_description" role="button" aria-expanded="true" aria-controls="pd_description">Description <i class="bi bi-chevron-up"></i></a>
                                    ...
                                    <div class="pd-collapse-row">
                                        <a class="pd-collapse-h5" data-bs-toggle="collapse" href="#pd_information" role="button" aria-expanded="false" aria-controls="pd_information">Information <i class="bi bi-chevron-up"></i></a>
                                            ...
                                            <div class="pd-collapse-box">
                                                <div class="row align-items-end">
                                                    ...
                                                    <div class="col-sm-6 text-sm-end">
                                                        ...
                                                        <a data-bs-toggle="collapse" href="#pd_add_review" role="button" aria-expanded="false" aria-controls="pd_add_review">Write a review</a>
                                                    </div>
                                                ...
                                                <div class="d-flex review-box border-top mt-3 pt-3">
                                                    ...
                                                    <div class="col ps-3">
                                                        ...
                                                        <p class="m-0 pt-2 small">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                                    </div>
                                                </div>
                                                <div class="d-flex review-box border-top mt-3 pt-3">
                                                    <div>
